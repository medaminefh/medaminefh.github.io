...
import { w as toNodeListener, f as destr, z as useRuntimeConfig, x as trapUnhandledNodeErrors, v as setupGracefulShutdown, y as useNitroApp } from './chunks/_/nitro.mjs';
import 'node:events';
import 'node:buffer';
import 'node:fs';
import 'node:path';
